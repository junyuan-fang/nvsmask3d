...
class Experiment:
    def __init__(self, scene_names: list, load_configs:list, project_name: str, gt_camera_rgb: bool, gt_camera_gaussian: bool,
...
def create_experiments(scene_names: list, load_configs:list, project_name: str, experiment_type: str, dataset: str, sam: bool, algorithm: int, wandb_mode: str = "online", kind = "crop"):
...
def run_experiments(scene_names: list = SCENE_NAMES, load_configs:list = LOAD_CONFIGS, experiment_type: str = None, dataset: str = "replica", sam: bool = False, algorithm: int = 0, project_name: str = "depth_corrected", wandb_mode: str = "online", kind = "crop"):
...
if __name__ == "__main__": 
    run_experiments(experiment_type="rgb", dataset="replica", sam=False, algorithm=0, project_name="crop", wandb_mode="online", kind="blur")# online,offline,disabled
